...
<title><spring:message code="addVacctinationData.title" /></title>
<!-- Bootstrap core CSS -->
...
<body>
	...
	<div class="container">
		<div class="header clearfix">
			...
			<h3 class="text-muted">
				<spring:message code="addVacctinationData.title" />
			</h3>
		</div>
		...
		<form id="frm1" action="addvacdata" method="post">
			...
			<c:if test="${not command.addSuccessfull}">
				...
				<p>
					<spring:bind path="command.dose">
						<label class="data-label"><spring:message
								code="addVacctinationData.dose" /></label>
				...
				<p>
					<spring:bind path="command.series">
						<label class="data-label"><spring:message
								code="addVacctinationData.series" /></label>
						<input type="text" name="${status.expression}"
							value="${status.value}">
						<c:if test="${fn:length(status.errorMessages) gt 0}">
							<div class="alert alert-danger">
