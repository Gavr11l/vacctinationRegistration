...
<title><spring:message code="vacctinationReport.title" /></title>
<!-- Bootstrap core CSS -->
...
<body>
	...
	<div class="container">
		<div class="header clearfix">
			...
			<h3 class="text-muted">
				<spring:message code="vacctinationReport.title" />
			</h3>
		</div>

		<div class="healthCertificate">
			<form id="frm2" action="pvacrep" method="get">
				<h2>
					<spring:message code="helthCertificate.msg10" />
				</h2>

				<p>
					<spring:message code="helthCertificate.msg6" />
					${command.patient.lastName} ${command.patient.firstName}
					${command.patient.middleName}
					<spring:message code="helthCertificate.msg4" />
					${command.domain.vacctinationDate}
					<spring:message code="helthCertificate.msg1" />
					${command.vacctination.vacctinationType}.
					<spring:message code="helthCertificate.msg3" />
					: ${command.domain.dose},
					<spring:message code="helthCertificate.msg5" />${command.domain.series}.
				</p>

				<p>
					<spring:message code="helthCertificate.msg9" />
					${command.vacctinationResult.result}
				</p>
				<p>
					<spring:message code="helthCertificate.msg7" />
					${command.vacctinationResult.localReaction}
				</p>
				<p>
					<spring:message code="helthCertificate.msg8" />
					${command.vacctinationResult.globalReaction}
				</p>
