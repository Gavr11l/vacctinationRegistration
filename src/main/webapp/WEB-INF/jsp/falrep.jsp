...
<title><spring:message code="faultReport.title" /></title>
<!-- Bootstrap core CSS -->
...
<body>
	...
	<div class="container">
		<div class="header clearfix">
			...
			<h3 class="text-muted">
				<spring:message code="faultReport.title" />
			</h3>
		</div>


		<form action="falrep" method="get" id="frm2">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th><spring:message
									code="table.faultReport.vacctinationFaultDate" /></th>
							<th><spring:message code="table.faultReport.faultTime" /></th>
							<th><spring:message code="table.faultReport.faultReason" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="row" items="${command.wrapperList }">
							<tr>
								...
								<td>${row.patientVacctinationFault.vacctinationFaultDate}</td>
								<td>${row.patientVacctinationFault.faultTime}</td>
								<td>${row.patientVacctinationFault.faultReason}</td>
								<td><c:url var="reportLink" value="pfalrep">
