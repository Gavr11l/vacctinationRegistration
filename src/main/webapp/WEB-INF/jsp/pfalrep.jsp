...
<body>
	...
	<div class="container">
		...
		<div class="healthCertificate">
			<form id="frm2" action="pfalrep" method="get">


				<h2>
					<spring:message code="helthCertificateFault.msg7" />
				</h2>

				<p>
					<spring:message code="helthCertificateFault.msg2" />
					${command.patient.lastName} ${command.patient.firstName}
					${command.patient.middleName}
					<spring:message code="helthCertificateFault.msg4" />
					${command.patientVacctinationFault.vacctinationFaultDate}
					<spring:message code="helthCertificateFault.msg1" />
					${command.vacctination.vacctinationType},
					<spring:message code="helthCertificateFault.msg5" />
					: ${command.patientVacctinationFault.faultReason},
					<spring:message code="helthCertificateFault.msg3" />
					: ${command.patientVacctinationFault.faultTime}
