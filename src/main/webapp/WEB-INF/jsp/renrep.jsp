...
<body>
	...
	<div class="container">
		<div class="header clearfix">
			<nav>
				<ul class="nav nav-pills pull-right">
					<li role="presentation"><a href="/app/mainform"><spring:message code="common.home" /></a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown" role="button" aria-haspopup="true"
						aria-expanded="false"><spring:message code="common.language" />
							<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="#" onclick="switchLanguage('ru');"><spring:message code="common.lru" /></a></li>
							<li><a href="#" onclick="switchLanguage('en');"><spring:message code="common.len" /></a></li>
							<li><a href="#" onclick="switchLanguage('ua');"><spring:message code="common.lua" /></a></li>
						</ul></li>
					<li role="presentation"><a href="/app/logout"><spring:message code="common.logout" /></a></li>
				</ul>
				<ul class="nav nav-pills pull-right">
		...
		<form action="renrep" method="get" id="frm2">
			<div class="row">
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="form-group">
						<label for="sel1"><spring:message code="vacctinationChoice" /></label>
				...
				<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					<div class="radio-btn">
						<label><spring:message code="dateTypeChoice" /> <spring:bind path="command.dateType"></label>
						<p>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th><spring:message
									code="table.renouncementReport.renouncementDate" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="row" items="${command.wrapperList }">
							<tr>
								...
								<td>${row.patientVacctinationRenouncement.renouncementDate}</td>
								<td><c:url var="reportLink" value="prenrep">
										<c:param name="ptid" value="${row.patient.idPatient}" />
										<c:param name="vcid"
											value="${row.vacctination.idVacctination}" />
									</c:url> <a id="atb" href="${reportLink}"> <spring:message
			...
			<input type="hidden" name="action" id="action"> <input
				...
				onclick="doSsubmit('Refresh')" /> <input type="button"
