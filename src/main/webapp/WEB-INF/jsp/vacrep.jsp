...
<body>
	...
	<div class="container">
		...
		<form action="vacrep" method="get" id="frm2">
			<div class="row">
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th><spring:message
									code="table.vacctination.vacctinationResult" /></th>
							<th><spring:message
									code="table.vacctination.vacctinationLocalReaction" /></th>
							<th><spring:message
									code="table.vacctination.vacctinationGlobalReaction" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="row" items="${command.wrapperList }">
							<tr>
								...
								<td>${row.patientVacctinaion.vacctinationDate}</td>
								<td>${row.patientVacctinationResult.result}</td>
								<td>${row.patientVacctinationResult.localReaction}</td>
								<td>${row.patientVacctinationResult.globalReaction}</td>
								<td><c:url var="reportLink" value="pvacrep">
										...
										<c:param name="vcid"
											...
											code="link.get.healthCertificate" /></a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
