...
<title><spring:message
		code="addVacctinationResultDataList.title" /></title>
<!-- Bootstrap core CSS -->
...
<body>
	...
	<div class="container">
		<div class="header clearfix">
			...
			<h3 class="text-muted">
				<spring:message code="addVacctinationResultDataList.title" />
			</h3>
		</div>
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th><spring:message
									code="table.vacctination.vacctinationResExist" /></th>
						</tr>
					</thead>
					<tbody>
						<c:forEach var="row" items="${command.wrapperList }">
							<tr>
								...
								<c:choose>
									<c:when test="${row.patientVacctinationResult != null}">
										<td><spring:message
												code="table.vacctination.vacctinationResExistYes" /></td>
									</c:when>
									<c:otherwise>
										<td><spring:message
												code="table.vacctination.vacctinationResExistNo" /></td>
									</c:otherwise>
								</c:choose>


								<td><c:url var="addLink" value="addvacresdata">
